...
public interface Element
{
    ...
    /**
     * @return - an element with the given priority and
     *  all other properties are the same as the current element 
     */
    Element withPriority(int priority);

    /**
     * @return - an element with the given due date and
     *  all other properties are the same as the current element 
     */
    Element withDueDate(LocalDate date);

    /**
     * @return - an element with the given status and
     *  all other properties are the same as the current element 
     */
    Element withStatus(Status status);

    /**
     * @return - an element with the given name and
     *  all other properties are the same as the current element 
     */
    Element withName(String name);

    /**
     * @return - an element with the given description and
     *  all other properties are the same as the current element 
     */
